    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">{cars.length} vehicles in fleet</p>
        </div>
        <Link href="/admin/cars/new">
          <Button className="bg-[#E8FF00] text-black font-bold hover:bg-[#d4e800]">
                ...
                >
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      <div className="relative h-10 w-16 overflow-hidden rounded-lg bg-zinc-800 shrink-0">
                        {car.images[0] && (
                          <Image
                            src={car.images[0]}
                            alt={car.name}
                      ...
                      <div>
                        ...
                        <p className="text-xs text-zinc-500">{car.brand} · {car.year}</p>
                      </div>
                    </div>
                  </td>
